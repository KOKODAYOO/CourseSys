  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="query.account" placeholder="工号" class="handle-input mr10"></el-input>
...
export default {
  ...
  methods: {
    // 获取数据
    getData() {
      var url = "http://localhost:8082/user/getTeacher";
    ...
    handleSearch() {
      ...
      var url =
        "http://localhost:8082/user/getTeacherBy?name=" +
        name +
        "&account=" +
        account;
      this.$axios.get(url).then(res => {
    ...
    handleDelete(index, row) {
      ...
      this.$confirm("确定要删除吗？", "提示", {
        ...
        .then(() => {
          ...
          var url = "http://localhost:8082/user/deleteTeacher?id=" + row.id;
          this.$axios
            .get(url)
            .then(res => {
              //console.log(res);
    ...
    saveEdit() {
      ...
      this.$axios
        .post(
          "http://localhost:8082/user/modifyTeacher",
    ...
    saveAdd() {
      ...
      this.$axios
        .post(
          "http://localhost:8082/user/newTeacher",
